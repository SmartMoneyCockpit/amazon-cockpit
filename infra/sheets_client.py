...
def _read_creds():
    ...
    raise FileNotFoundError("No GCP credentials found. Set st.secrets['gcp_service_account_json'] OR env GCP_SERVICE_ACCOUNT_JSON OR GOOGLE_APPLICATION_CREDENTIALS.")
...
class SheetsClient:
    def __init__(self):
        ...
        self.sh = self.gc.open_by_key(_sheet_key())
