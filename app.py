...
# === Custom Amazon-style accordion sidebar ===
# Hide the default Streamlit pages sidebar list
st.markdown(
    """
    <style>
    [data-testid="stSidebarNav"] {display: none;}
    /* Optional: tighten sidebar spacing */
    section[data-testid="stSidebar"] .css-1d391kg {padding-top: 0rem;}
    </style>
    """,
...
with st.sidebar:
    ...
    with st.expander("Finance", expanded=False):
        ...
        st.page_link("pages/26_Finance_Monthly_Export.py", label="Finance Monthly Report")
